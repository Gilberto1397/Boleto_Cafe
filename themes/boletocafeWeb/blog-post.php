<?php $v->layout("_theme"); ?>
    ...
    <article class="post_page">
        ...
        <div class="post_page_related content"> <!--  SÓ VAI APARECER QUANDO TIVER BLOGS RELACIOANDO -->
            <section>
                ...
                <div class="blog_articles">
                    <?php foreach ($related as $more): ?>
                        <?php $v->insert("blog-list", ["post" => $more]); ?> <!-- REENVIO DOS DADOS POIS JA ESTAMOS ACESSANDO UM POST -->
                    <?php endforeach; ?>
                </div>
            </section>
        </div>
